...
class BasicSeq2Seq(Seq2SeqModel):
  ...
  def __init__(self, params, mode, name="basic_seq2seq"):
    ...
    self.encoder_class = UnidirectionalRNNEncoder
    self.decoder_class = BasicDecoder
  ...
  def default_params():
    ...
    params.update({
        ...
        "encoder.params": {"state_is_tuple": True},  # Arbitrary parameters for the encoder
  ...
  def encode(self, features, labels):
    ...
    encoder_fn = UnidirectionalRNNEncoder(self.params["encoder.params"], self.mode)
